...
//    {
//        /// <summary>
//        /// Este método solo se debe llamar después de haber iniciado sesión
//        /// </summary>
//        /// <returns>Devuelve una instacia de Realm</returns>
...
//            //else
//            //{
//            //    user = App.RealmApp.LogInAsync(Credentials.Anonymous()).Result;
...
//                    realm.Subscriptions.Add(incidencias, new SubscriptionOptions { Name = "Incidencia" });
//                    realm.Subscriptions.Add(personas, new SubscriptionOptions { Name = "Persona" });
//                }
//            };
